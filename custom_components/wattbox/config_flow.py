...
from .const import DOMAIN, DEFAULT_NAME, DEFAULT_PASSWORD, DEFAULT_PORT, DEFAULT_USER, DEFAULT_SCAN_INTERVAL
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            try:
                ...
                unique_id = info.get("serial_number") or f"{info['host']}_{info['port']}"
